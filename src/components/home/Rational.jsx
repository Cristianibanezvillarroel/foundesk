    ...
    <>
      <div id='rational-left' >
        ...
        <div id='rational-left-bajada'>
          <p>Accede a cursos online exclusivamente diseñados para tus necesidades como emprendedor, y logra dominio de nuevas habilidades en el horario y momento que puedas.</p>
        </div>
        <div>
          <RationalAccordion />
        </div>
